    ...
    return (
        <div>
            ...
            {/* <section className="overflow-hidden h-full md:h-screen">
                {/* <Particle></Particle> */}
                {/* <div className="container px-5 py-10 mx-auto pt-10 lg:pt-24">

                    <div className="md:flex gap-6 -m-1 md:-m-2"> */}

                        {/* <div className="md:flex md:flex-wrap gap-5 md:w-1/2">  */}
                            ...
                            <div className="w-full p-1 md:p-2">
                                <div className="dropdown dropdown-hover h-full">
                                    ...
                                    <div tabIndex="0" className="dropdown-content menu p-5 shadow bg-[#014b4d] rounded-box w-80 md:w-96 h-96">
                                        ...
                                        <button onClick={() => navigateToDetails(_id)} className="" > Read More </button>
                                    </div>
                                </div>
                            </div>
